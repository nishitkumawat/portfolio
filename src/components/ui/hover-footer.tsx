  ...
  const contactInfo = [
    {
      ...
      text: "nishit1060@gmail.com",
      href: "mailto:nishit1060@gmail.com",
    },
    {
      icon: <Phone size={18} className="text-[#3ca2fa]" />,
      text: "+91 9104513411",
      href: "tel:+919104513411",
    },
    {
      ...
      <div className="max-w-7xl mx-auto p-10 md:p-14 z-40 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12">
          <div className="flex flex-col space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-white text-3xl font-bold">Nishit</span>
            </div>
            <p className="text-sm leading-relaxed text-slate-300">
              A full stack and backend-focused developer who loves turning ideas into
              reliable, well-designed software.
            </p>
          </div>
                ...
                {section.links.map((link) => (
                  <li key={link.label} className="relative">
                    ...
                    {"pulse" in link && link.pulse && (
                      <span className="absolute top-0 right-[-10px] w-2 h-2 rounded-full bg-[#3ca2fa] animate-pulse-slow"></span>
                    )}
                  </li>
                ))}
              </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm space-y-4 md:space-y-0">
          ...
          <p className="text-center md:text-left text-slate-400">
            &copy; {new Date().getFullYear()} Nishit Kumawat. All rights reserved.
          </p>
        </div>
      </div>

      <div className="lg:flex hidden h-[30rem] -mt-52 -mb-36">
        <TextHoverEffect text="Nishit" className="z-50" />
      </div>
